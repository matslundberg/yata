...
createToken({ name: "Due", pattern: /due/ })
createToken({ name: "PeriodSpecificYesterday", pattern: /yesterday/ })
createToken({ name: "PeriodSpecificTomorrow", pattern: /tomorrow/ })
createToken({ name: "PeriodSpecificToday", pattern: /today/ })
...
createToken({ name: "Identifier", pattern: /\w+/ })
